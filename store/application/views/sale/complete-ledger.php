                ...
                <tbody>
                    ...
                    foreach ($ledger as $results) {
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a class="btn btn-warning btn-sm" href="<?php echo base_url('sale/saleReceipt/' . $results->sales_no) ?>"><i class="fa fa-file-pdf-o" style="font-size:20px; color:red;"></i>Receipt</a></td>
                            <!-- <td>

...
<head>
	<meta charset="utf-8" />
	<title>Administrator Panel | <?php echo ucwords(PROJECT_NAME); ?></title>
	...
	<link href="<?php echo base_url('../'); ?>portal_assets/vendors/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
	...
	<!-- <link href="<?php #echo base_url(); 
				?>portal_assets/vendors/general/tether/dist/css/tether.css" rel="stylesheet" type="text/css" /> -->
	...
	<!-- <link href="<?php #echo base_url(); 
				?>portal_assets/vendors/general/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.css" rel="stylesheet" type="text/css" /> -->
	...
	<!-- <link href="<?php #echo base_url(); 
				?>portal_assets/vendors/general/ion-rangeslider/css/ion.rangeSlider.css" rel="stylesheet" type="text/css" /> -->
	<!-- <link href="<?php #echo base_url(); 
				?>portal_assets/vendors/general/nouislider/distribute/nouislider.css" rel="stylesheet" type="text/css" /> -->
	<!-- <link href="<?php #echo base_url(); 
				?>portal_assets/vendors/general/owl.carous'../'el/dist/portal_assets/owl.carousel.css" rel="stylesheet" type="text/css" /> -->
	<!-- <link href="<?php #echo base_url(); 
				?>portal_assets/vendors/general/owl.carous'../'el/dist/portal_assets/owl.theme.default.css" rel="stylesheet" type="text/css" /> -->
	<!-- <link href="<?php #echo base_url(); 
				?>portal_assets/vendors/general/dropzone/dist/dropzone.css" rel="stylesheet" type="text/css" /> -->
	<!-- <link href="<?php #echo base_url(); 
				?>portal_assets/vendors/general/summernote/dist/summernote.css" rel="stylesheet" type="text/css" /> -->
	...
	<!-- <link href="<?php #echo base_url(); 
				?>portal_assets/vendors/general/morris.js/morris.css" rel="stylesheet" type="text/css" /> -->
...
<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
	...
	<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
		<div class="kt-header-mobile__logo">
			<a href="index.php">
				<img alt="Logo" src="<?php echo base_url('../'); ?>portal_assets/images/logo.png" style="height:25px;width:25px;" />
			</a>
		</div>
				...
				<div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
					<div class="kt-aside__brand-logo text-center">
						<a href="<?php echo base_url(); ?>">
							<img alt="Logo" src="<?php echo base_url('../'); ?>portal_assets/images/favicon.png" style="height:50px; width:50px;" />
						</a>
					</div>
					<h4 class="ml-2 mt-3 text-light"><?php echo strtoupper(PROJECT_NAME); ?></h4>

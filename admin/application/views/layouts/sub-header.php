						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-subheader__main">
								...
								<div class="kt-subheader__breadcrumbs">
									<a href="<?php echo site_url('dashboard'); ?>" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
									<h3 class="kt-subheader__title">
										<?php echo basename(strtoupper(str_replace('-', ' ', $this->uri->segment(2)))); ?>
								</div>
							</div>
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									<a style = "cursor: pointer;" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker" data-toggle="kt-tooltip" data-placement="left">

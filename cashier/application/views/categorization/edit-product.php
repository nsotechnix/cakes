                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" value="<?= $PRODUCT_DETAILS[0]->cake_price; ?>" aria-describedby="our price" placeholder="Enter our price" name="cake_price" id="cake_price" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 p-3 mb-4" id="gst">
                        <div class="row">
                            ...
                            <div class="col-lg-12 p-3 mb-4" id="gst_including">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>GST (%)</label>
                                            <select name="GST_percent" id="gstpercent2" onchange="calculate_including_gstpercent(this.value, 'gstpercent2');" class="form-control">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>CGST Amount</label>
                                            <input type="number" class="form-control" aria-describedby="our price" placeholder="cgst_amount" name="cgst_amount" id="cgst_amount2" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>SGST Amount</label>
                                            <input type="number" class="form-control" aria-describedby="our price" placeholder="sgst_amount" name="sgst_amount" id="sgst_amount2" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Actual Price</label>
                                            <input type="number" class="form-control" aria-describedby="our price" placeholder="price" name="actual_price" id="actual_price2" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div></div>
                            <div class="custom-file">
                                <input type="date" value="<?= $PRODUCT_DETAILS[0]->expiry_date; ?>" class="form-control" id="" name="expiry_date" required>
                            </div>
                        </div>
                    </div> -->
                    <div class="col-md-4">
...
<script type="text/javascript">
    ...
    function calculate_excluding_gstpercent(id) {
        ...
        cgstpercent = ((id / amount) * amount) / 2;
    ...
    function calculate_including_gstpercent(id) {
        var amount = $('#cake_price').val() || 0
        var gstpercent = $('#gstpercent2').val() || 0
        cgstpercent = ((gstpercent / amount) * amount) / 2;
        var actual_price = ((amount - ((gstpercent) / 100 * amount))).toFixed(2)
        $("#actual_price2").val(actual_price);
        $("#cgst_amount2").val(cgstpercent);
        $("#sgst_amount2").val(cgstpercent);
    }
</script>

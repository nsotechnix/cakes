...
class Cashier_Sale_Model extends CI_Model
{
    ...
    public function select_pending_ledger($id)
    {
        $query = $this->db->select("
        ...
        sales_ledger.grand_total")
            ...
            ->where('sales_ledger.cashier_id', $id)->get();
        return $query->result();
    }

    //Select Completed Ledger 
    public function select_complete_ledger($id)
    {
        $query = $this->db->select("
        sales_ledger.ledger_id,
        sales_ledger.sales_no,

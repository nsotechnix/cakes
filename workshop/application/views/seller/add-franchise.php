<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor card">
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <h5 class="hk-sec-title">ADD NEW FRANCHISER</h5>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label mb-10" for="exampleInputuname_1">Select Franchise Type</label>
                                <div class="input-group">
                                    <select name="" class="form-control" id="">
                                        <option value="" disabled selected>Select type</option>
                                        <option value="">Mart</option>
                                        <option value="">Dipo</option>
                                        <option value="">Shoppie</option>
                                    </select>
                                </div>
                            </div>
                        </div>

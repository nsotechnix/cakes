...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor card">
	...
	<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
		...
		<form action="" method="post">
			<div class="row">
				<div class="col-sm-4">
					<input type="text" placeholder="Enter ID or Phone" name="rootEpin" class="form-control">
				</div>
				<div class="col-sm-4">
					...
					<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
						...
						<tbody>
							...
							function getMembers($epin) {
								...
								$level = $ci->Crud->ciRead('users', " (`epin` = '$rootEpin' OR `phone` = '$rootEpin')")[0]->level_from_top;

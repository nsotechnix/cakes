<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url('../'); ?>portal_assets/vendors/general/owl.carous'../'el/dist/portal_assets/owl.carousel.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url('../'); ?>portal_assets/vendors/general/owl.carous'../'el/dist/portal_assets/owl.theme.default.css" rel="stylesheet" type="text/css" />
			...
			<div class="kt-grid kt-grid--hor kt-grid--root kt-login kt-login--v2 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(<?php echo base_url('../'); ?>portal_assets/media//bg/bg-1.jpg);">
					<!-- <div class="kt-login__actions text-right">
                    	<a href="<?= base_url('../vendor/'); ?>" target="_blank"  style="color: #fff; border: 2px solid #fff; margin:10px 30px 0px 30px;" class="btn btn-pill kt-login__btn-primary">Login as a vendor</a>
                    </div> -->
							...
							<div class="kt-login__signin">
								...
								<form class="kt-form" action="<?php echo site_url('authentication/processLogin'); ?>" method = "post">
									<div class="input-group">
										<input class="form-control" type="text" style="border: 2px solid black; background: white; font-weight: bolder;" placeholder="Username" name="email" autocomplete="off" required value = "<?php echo set_value('email'); ?>">
									</div>
									<div class="input-group">
